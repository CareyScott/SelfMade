        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                      <a class="p-2 text-dark" href="{{route('home')}}"><li>Home</li></a>
                      <a class="p-2 text-dark" href="{{route('about')}}"><li>About</li></a>
                      <a class="p-2 text-dark" href="{{route('welcome')}}"><li>Welcome</li></a>
