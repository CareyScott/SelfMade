...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <p class="h2 mt-4 margin-left-custom">{{$employer->user->name}}</p>
            <nav class="nav nav-masthead justify-content-end mb-3">
                <a class="nav-link btn btn-sm btn-outline-primary" href="{{route('admin.employers.edit', $employer->id) }}">Edit Employer</a>
            </nav>
        </div>
            ...
            <div class="bg-light shadow-sm mx-auto text-dark mt-5 mb-5" style="width: 80%; border-radius: 21px 21px 21px 21px;">
                ...
                <div class="media text-muted pt-3">
                    ...
                    <p class="media-body pb-3 mb-0 medium lh-125 border-gray">
                        <a href="{{ route('admin.employers.show', $job) }}"><strong class="d-block text-dark">{{$job->title}}</strong></a>
                        {{$job->description}}
                    </p>
                </div>
                @endforeach
