...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            {{-- <nav class="nav nav-masthead justify-content-end mb-3">
                <a class="nav-link btn btn-sm btn-outline-primary" href="{{route('jobSeeker.jobSeekers.edit', $jobSeeker->id) }}">Edit Profile</a>
            </nav> --}}
        </div>
    ...
    <div class="float-right">
        ...
        <a href="{{route('jobSeeker.home') }}" class="btn btn-outline-dark"> Back</a>
    </div>
